...
export default function QuizPage() {
  ...
  return <main className="skill-reference quiz-page">
    ...
    <section className="quiz-workspace"><div className="page-width">
      ...
      {round && <div className="quiz-participation-summary"><span>PARTICIPAÇÃO DA RODADA</span><strong>{participation.started} {participation.started === 1 ? "entrou" : "entraram"} · {participation.completed} {participation.completed === 1 ? "concluiu" : "concluíram"}</strong></div>}
